...
- **Estado: montado y corriendo (26 de agosto de 2026).** `launchd` local armado (plist `~/Library/LaunchAgents/com.dannymera.nccontabilidades.synccarruseles.plist`), corre todos los días a las **10:00 AM hora del Mac** — 2 horas después de la rutina en la nube (8:00 AM Chile), mismo margen que Radar Comercial y Danny Mera Seguros. Primera corrida manual trajo los 21 carruseles acumulados desde el 20 de agosto (3 del lote manual + 18 de las 6 corridas automáticas del 21 al 26) sin pisar nada.
